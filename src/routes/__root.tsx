...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ReservaLab — Reservas sob controle" },
      { name: "description", content: "ReservaLab é o sistema de reservas para restaurantes e eventos: agenda organizada para o gestor, confirmação automática para o cliente." },
      ...
      { property: "og:title", content: "ReservaLab — Reservas sob controle" },
      { property: "og:description", content: "Agenda organizada para o gestor, confirmação automática para o cliente." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ReservaLab — Reservas sob controle" },
