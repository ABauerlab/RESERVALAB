...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Reserve sua mesa, aniversário ou evento no Iracema. Simples, rápido e elegante." },
      ...
      { property: "og:description", content: "Reserve sua mesa, aniversário ou evento no Iracema." },
